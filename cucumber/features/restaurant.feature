...
And I login with valid credentials
  When I perform a search for 'Burgers'
  And I click on the first restaurant result for 'Burgers'
  Then I should be presented with the correct information for 'The Counter'
...
And I login with valid credentials
  When I perform a search for 'Burgers'
  And I click on the first restaurant result for 'Burgers'
  And I click on the address for 'The Counter'
...
And I login with valid credentials
  When I perform a search for 'Burgers'
  And I click on the first restaurant result for 'Burgers'
  And I click on the website for 'The Counter'
